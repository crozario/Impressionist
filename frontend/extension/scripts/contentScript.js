...
let contentInfo = {
    ...
    characterArray : null, // list of character names
    dialoguePerCharacterDict : null, // list of dialogue indexes per character
    characterPickedIndex : null,
    pickedCharacterArray : null
}
...
let goToPreviousDialogue = () => {
    if (contentInfo.previousDialogueID !== null) {
        const previousStartDialogue = contentInfo.dialogueTimeArray[contentInfo.previousDialogueID][0];
...
let goToNextDialogue = () => {
    if (contentInfo.nextDialogueID !== null) {
        const nextStartDialogue = contentInfo.dialogueTimeArray[contentInfo.nextDialogueID][0];
...
let updateDialogueID = () => {
    ...
    if (currentDialogueID !== null) {
        ...
        if (doesDialogueExist(contentInfo.currentDialogueID + 1, contentInfo.dialogueTimeArray)) { // check if next dialogue exists
        ...
        if (contentInfo.dialogueTimeArray.length > 0) {
            ...
            } else if (doesDialogueExist(contentInfo.previousDialogueID + 1, contentInfo.dialogueTimeArray)) {
...
let checkDialogueIsCharacterPicked = () => {
    if(contentInfo.currentDialogueID !== null && contentInfo.pickedCharacterArray !== null) {
        if(contentInfo.pickedCharacterArray.includes(contentInfo.currentDialogueID)) {
